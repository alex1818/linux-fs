...
#define RXRPC_RX_ANNO_VERIFIED	0x80		/* Set if verified and decrypted */
	rxrpc_seq_t		tx_cursor;	/* Dead slot in buffer; the first transmitted but
...
struct rxrpc_call *rxrpc_get_call_maybe(struct rxrpc_call *);
...
static inline bool __rxrpc_queue_call(struct rxrpc_call *call)
{
...
static inline bool rxrpc_queue_call(struct rxrpc_call *call)
{
	if (!rxrpc_get_call_maybe(call))
		return false;
	return __rxrpc_queue_call(call);
}
